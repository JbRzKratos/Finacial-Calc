...
import { AppBottomNav } from "@/components/common/BottomNav/BottomNav";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="max-w-[420px] mx-auto px-[clamp(12px,4vw,20px)] pb-[clamp(150px,38vw,200px)] md:px-7 md:py-4 animate-panel-enter">
            {left}
          </div>
        </section>
