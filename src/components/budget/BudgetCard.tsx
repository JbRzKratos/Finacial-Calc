            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Button
                  ...
                  className="w-7 h-7 rounded-lg p-0 flex items-center justify-center opacity-40 hover:opacity-100 hover:bg-[#EF4444]/10"
        ...
        {showDelete && (
          <div className="absolute inset-0 bg-[#0A0A0C]/95 backdrop-blur-sm flex items-center justify-center gap-3 z-10 rounded-2xl">
            ...
            <Button
              ...
              className="px-4 py-2 rounded-xl bg-[#EF4444] hover:bg-[#EF4444]/90 text-white text-xs font-bold h-auto active:scale-95"
            >
              Delete
            </Button>
            <Button
              ...
              className="px-4 py-2 rounded-xl bg-[#1C1C1F] hover:bg-[#222226] text-[#8A8A90] text-xs font-bold h-auto active:scale-95"
            >
              Cancel
            </Button>
          </div>
