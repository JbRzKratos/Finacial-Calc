  ...
  return (
    <div className="mt-6 mb-2 animate-metric">
      <div className="relative h-1.5 bg-[rgba(0,0,0,0.06)] rounded-full overflow-hidden">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-brand-primary border-[3px] border-white shadow-[0_2px_8px_rgba(255,107,0,0.3)]" style={{ left: "0%" }} />
