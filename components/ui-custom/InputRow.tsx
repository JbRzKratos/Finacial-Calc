        ...
        <div className="input-brand" key={`${uid}-${i}`}>
          <div className="relative">
            <input
              ...
              className={cn(
                "w-full h-12 rounded-[6px] bg-black/20 border-2 border-white/20 text-white text-[16px] font-semibold tabular-nums min-h-[48px] transition-all duration-200",
                "focus:border-white/90 focus:bg-black/30 focus:outline-none",
